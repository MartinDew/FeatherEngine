...
file(GENERATE OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/FeatherTargets-$<CONFIG>.cmake" CONTENT "\
...
set_property(TARGET Feather::Editor PROPERTY
    INTERFACE_INCLUDE_DIRECTORIES \"${CMAKE_CURRENT_SOURCE_DIR}\" \"${CMAKE_CURRENT_SOURCE_DIR}/core\"
)
...
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/FeatherTargets.cmake" "\
...
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/FeatherConfig.cmake" "\
...
set(FEATHER_ENGINE_DIR \"${CMAKE_CURRENT_SOURCE_DIR}\")
    ...
    if(TARGET \${_target})
        set_property(TARGET \${_target} APPEND PROPERTY
            INTERFACE_INCLUDE_DIRECTORIES
                ...
                \"${CMAKE_CURRENT_BINARY_DIR}/_deps/directxmath-src/Inc\"
                \"${CMAKE_CURRENT_BINARY_DIR}/_deps/flecs-src/include\"
        )
    endif()
endforeach()
