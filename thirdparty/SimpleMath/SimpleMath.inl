...
_Use_decl_annotations_
inline void Vector2::transform_normal(const Vector2* varray, size_t count, const Matrix& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::transform_normal(const Vector3* varray, size_t count, const Matrix& m, Vector3* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline Matrix Matrix::create_billboard(
...
_Use_decl_annotations_
inline Matrix Matrix::create_constrained_billboard(
    const Vector3& object,
    const Vector3& cameraPosition,
